export const experience = [
  ...
  },
  {
    ...
    details: [
      ...
      "Onboarded ~100 beta users; rapid iteration via feedback loops",
      "Designed habit, friends, and data tracking modules for retention",
    ],
  ...
  },
  {
    ...
    details: [
      ...
      "Fine-tuning model + BCE loss variants for improved generalization",
      "Targeting publication (ICASSP / INTERSPEECH)",
    ],
